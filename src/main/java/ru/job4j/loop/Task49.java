 ...
 * <p>
 * Задание: Написать код, который выводит в консоль все четные числа
 * от n до m (оба включительно). Числа при выводе
 * должны разделяться знаком "+". Учитывать, что неизвестно какое
 * из чисел больше - n или m.
 * <p>
